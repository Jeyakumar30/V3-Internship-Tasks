...
img_dir = r"D:\Data Science\V3 Python Tasks\OpenCV\Annotations\barcode_poly_yolo\images"
output_dir = r"D:\Data Science\V3 Python Tasks\OpenCV\Annotations\barcode_poly_yolo\output"
labels = r"D:\Data Science\V3 Python Tasks\OpenCV\Annotations\barcode_poly_yolo\labels"
...
def draw_polylines(image_path, label_file, output_dir):
    ...
    with open(label_file, 'r') as file:
        ...
        for line in lines:
            ...
            print(f"Image with annotations saved at: {output_path}")
